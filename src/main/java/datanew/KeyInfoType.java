...
public class KeyInfoType {
    ...
    @XmlElement(name = "KeyName", namespace = "http://www.w3.org/2000/09/xmldsig#", required = true)
    protected String keyName;
    @XmlElement(name = "X509Data", namespace = "http://www.w3.org/2000/09/xmldsig#", required = true)
    protected X509DataType x509Data;
    @XmlElement(name = "MgmtData", namespace = "http://www.w3.org/2000/09/xmldsig#", required = true)
     ...
     *     
     */
    public void setMgmtData(String value) {
        this.mgmtData = value;
    }
